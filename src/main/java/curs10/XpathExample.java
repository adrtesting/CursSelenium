...
public class XpathExample extends BaseTest {
	...
	@Test(priority=0)
	public void xPatchExample1() throws InterruptedException {
	...
	public void xpathExample2() {
		...
		//th/span[contains(@class,'nobr')]
		
		driver.findElement(By.xpath("//td[contains(@class,'woocommerce-orders-table_cell-order-number')]/a[contains(text(), '#1653')]")).click();
